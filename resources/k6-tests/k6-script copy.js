...
export default function () {
  group("sdc", function () {
    postman[Request]({
      ...
      method: "GET",
      address: "http://localhost:3000/products/",
      data: "{\n    page: 100\n    count: 50\n}",
      post(response) {
    ...
    postman[Request]({
      ...
      method: "GET",
      address: "http://localhost:3000/products/999999",
      post(response) {
        pm.test("Status code is 200", function () {
          pm.response.to.have.status(200);
        });
    ...
    postman[Request]({
      ...
      method: "GET",
      address: "http://localhost:3000/products/454755",
      post(response) {
        pm.test("Status code is 200", function () {
          pm.response.to.have.status(200);
        });
    ...
    postman[Request]({
      ...
      method: "GET",
      address: "http://localhost:3000/products/1",
      post(response) {
        pm.test("Status code is 200", function () {
          pm.response.to.have.status(200);
        });
    ...
    postman[Request]({
      ...
      method: "GET",
      address: "http://localhost:3000/products/999999/styles",
      post(response) {
        pm.test("Status code is 200", function () {
          pm.response.to.have.status(200);
        });
    ...
    postman[Request]({
      ...
      method: "GET",
      address: "http://localhost:3000/products/700000/styles",
      post(response) {
        pm.test("Status code is 200", function () {
          pm.response.to.have.status(200);
        });
    ...
    postman[Request]({
      ...
      method: "GET",
      address: "http://localhost:3000/products/700000/related",
      post(response) {
        pm.test("Status code is 200", function () {
          pm.response.to.have.status(200);
        });
    ...
    postman[Request]({
      ...
      method: "GET",
      address: "http://localhost:3000/products/999999/related",
      post(response) {
        pm.test("Status code is 200", function () {
          pm.response.to.have.status(200);
        });
